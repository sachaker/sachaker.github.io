...
<img style="float: right; margin: 0px 15px 15px 0px;" src="{{site.imgurl}}/map.gif" width="33%" />
...
<img src="https://github.com/sachaker/deeplabcut_texteam/blob/master/Protocols/Images/alternateGUI_20nodes.gif" alt="Labeling" width="65%" align="right"/>
